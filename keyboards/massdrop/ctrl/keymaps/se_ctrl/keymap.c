...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_G1] = LAYOUT(
        ...
        KC_LALT, KC_CAPS, KC_RCTL,                   _______,                            _______, _______, TT(_S2), _______,            _______, _______, _______ \
    ),
    [_S1] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______, \
    ...
    [_S2] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, KC_NLCK, KC_KP_7, KC_KP_8, KC_KP_9, KC_PSLS, KC_PAST, KC_PMNS, _______,   _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, KC_KP_4, KC_KP_5, KC_KP_6, KC_PSLS, KC_PPLS, _______, _______,   _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, KC_KP_1, KC_KP_2, KC_KP_3, KC_PSLS, KC_PENT, KC_PENT, \
        _______, _______, _______, _______, _______, KC_SPC , KC_KP_0, KC_KP_0, KC_PDOT, KC_PDOT, KC_PENT, _______,                              _______, \
        _______, _______, KC_LGUI,                   KC_KP_0,                            _______, _______, _______, _______,            _______, _______, _______ \
    ),
    [_AT] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______, \
    ...
    [_MO] = LAYOUT(
        ...
        TG(_MO), KC_KP_1, KC_KP_2, KC_KP_3, KC_PENT, KC_ACL0, KC_BTN1, KC_BTN2, KC_BTN3, _______, _______, _______,                              _______, \
    ...
    [_FNC] = LAYOUT(
        ...
        KC_GRV , DF(_QW), DF(_CM), TG(_AT), TG(_S1), TG(_S2), TG(_G1), _______, _______, _______, _______, _______, _______, _______,   KC_MPLY, KC_MSTP, KC_VOLU, \
        RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI, _______, U_T_AUTO,U_T_AGCR,_______, _______, _______, _______, _______,   KC_MPRV, KC_MNXT, KC_VOLD, \
        KC_CAPS, RGB_RMOD,RGB_HUD, RGB_SAD, RGB_VAD, RGB_SPD, _______, _______, _______, _______, _______, _______, _______, \
        _______, _______, _______, _______, _______, MD_BOOT, TG_NKRO, _______, _______, _______, _______, _______,                              _______, \
