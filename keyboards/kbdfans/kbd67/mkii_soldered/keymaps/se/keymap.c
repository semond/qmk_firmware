...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
	[_CM] = LAYOUT_all( /* Colemak */
		...
		TT(_AR) , KC_LALT , KC_LGUI,          KC_SPC,           KC_SPC,           KC_SPC,                   KC_RALT , KC_RCTL ,           KC_LEFT , KC_DOWN , KC_RGHT
	),
	...
	[_FN] = LAYOUT_all( /* Qwerty */
		...
		_______ , _______ , KC_LGUI ,        _______,           _______,         _______,                   _______ , _______ ,           _______ , _______ , KC_NUBS
	),
