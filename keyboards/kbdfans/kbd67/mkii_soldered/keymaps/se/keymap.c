...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
	[_CM] = LAYOUT_all( /* Colemak */
		...
		SE_CTRL ,           KC_A    , KC_R    , KC_S    , KC_T    , KC_D    , KC_H    , KC_N    , KC_E    , KC_I    , KC_O    , KC_QUOT ,         KC_ENT    ,           KC_PGUP ,
		KC_LSFT , KC_BSLS , KC_Z    , KC_X    , KC_C    , KC_V    , KC_B    , KC_K    , KC_M    , KC_COMM , KC_DOT  , KC_SLSH ,        KC_RSFT ,              KC_UP   , KC_PGDN ,
		TT(_AR) ,      KC_LALT ,      KC_LGUI,          KC_SPC,           KC_SPC,           KC_SPC,                   KC_RALT , MO(_FN) ,           KC_LEFT , KC_DOWN , KC_RGHT
	),
	[_QW] = LAYOUT_all( /* Qwerty */
		KC_ESC  ,           KC_1    , KC_2    , KC_3    , KC_4    , KC_5    , KC_6    , KC_7    , KC_8    , KC_9    , KC_0    , KC_MINS , KC_EQL  , KC_BSPC , KC_DEL  , KC_DEL  ,
		KC_TAB  ,           KC_Q    , KC_W    , KC_E    , KC_R    , KC_T    , KC_Y    , KC_U    , KC_I    , KC_O    , KC_P    , KC_LBRC , KC_RBRC ,           KC_BSLS , KC_GRV  ,
		SE_CTRL ,           KC_A    , KC_S    , KC_D    , KC_F    , KC_G    , KC_H    , KC_J    , KC_K    , KC_L    , KC_SCLN , KC_QUOT ,         KC_ENT    ,           KC_PGUP ,
		KC_LSFT , KC_BSLS , KC_Z    , KC_X    , KC_C    , KC_V    , KC_B    , KC_N    , KC_M    , KC_COMM , KC_DOT  , KC_SLSH ,        KC_RSFT ,              KC_UP   , KC_PGDN ,
		TT(_AR) ,      KC_LALT ,      KC_LGUI,          KC_SPC,           KC_SPC,           KC_SPC,                   KC_RALT , MO(_FN) ,           KC_LEFT , KC_DOWN , KC_RGHT
	),
	[_S1] = LAYOUT_all( /* Qwerty */
		_______ ,           _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , TT(_AR) ,
		...
		_______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,        _______ ,              _______ , _______ ,
		KC_LCTL ,      _______ ,      SE_MEH  ,         _______,           _______,         _______,                  _______ , _______ ,           _______ , _______ , _______
	),
	[_S2] = LAYOUT_all( /* Qwerty */
	...
	[_AR] = LAYOUT_all( /* Qwerty */
		KC_GRV  ,           KC_F1   , KC_F2   , KC_F3   , KC_F4   , KC_F5   , KC_F6   , KC_F7   , KC_F8   , KC_F9   , KC_F10  , KC_F11  , KC_F12  , _______ , _______ , _______ ,
		TT(_MO) ,           KC_MUTE , _______ , _______ , _______ , _______ , _______ , KC_PGUP , KC_UP   , _______ , _______ , _______ , _______ ,           _______ , MO(_F2) ,
		...
		TT(_AR) ,      _______ ,      _______ ,        _______,           _______,         _______,                   MO(_F2) , MO(_FN) ,           _______ , _______ , _______
	),
	[_F2] = LAYOUT_all( /* Qwerty */
	...
	[_MO] = LAYOUT_all( /* Qwerty */
		...
		_______ ,      KC_KP_0 ,      KC_PDOT ,        KC_ACL1,           KC_ACL1,         KC_ACL1,                   _______ , MO(_FN) ,           _______ , _______ , _______
	),
	[_FN] = LAYOUT_all( /* Qwerty */
		KC_GRV  ,           DF(_QW) , DF(_CM) , TG(_AT) , TG(_S1) , TG(_S2) , _______ , _______ , _______ , _______ , _______ , KC_LANG4, KC_LANG3, KC_INT4 , _______ , KC_LANG2,
		_______ ,           _______ , _______ , _______ , _______,  _______ , _______ , _______ , _______ , _______ , KC_PSCR , KC_SLCK , KC_PAUS ,           KC_INT2 , KC_LANG1,
		KC_CAPS ,           _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,         _______   ,           KC_HOME ,
		_______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,        _______ ,              KC_APP  , KC_END  ,
		_______ ,      _______ ,      _______ ,        _______,           _______,         _______,                   _______ , _______ ,           _______ , _______ , KC_NUBS
	),
	// [___] = LAYOUT_all( /* Qwerty */
	// 	_______ ,           _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,
	// 	_______ ,           _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,           _______ , _______ ,
	// 	_______ ,           _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,         _______   ,           _______ ,
	// 	_______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,        _______ ,              _______ , _______ ,
