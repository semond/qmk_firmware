...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
	...
	[_AR] = LAYOUT_all( /* Qwerty */
		...
		_______ , KC_MPRV , KC_MNXT , KC_VOLD , _______ , _______ , KC_HOME , KC_END  , KC_INS  , _______ , _______ , _______ , _______    ,        _______ , _______ ,
	...
	[_MO] = LAYOUT_all( /* Qwerty */
		...
		_______ , KC_KP_1 , KC_KP_2 , KC_KP_3 , KC_PENT , KC_ACL0 , KC_BTN1 , KC_BTN2 , KC_BTN3 , _______ , _______ , _______ , _______    ,        _______ , _______ ,
		_______ , KC_KP_0 , KC_PDOT ,        KC_ACL1,           KC_ACL1,         KC_ACL1,                   _______ , MO(_FN) ,           _______ , _______ , _______
	),
	[_FN] = LAYOUT_all( /* Qwerty */
		KC_GRV  , DF(_QW) , DF(_CM) , TG(_AT) , TG(_S1) , TG(_S2) , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , KC_LANG2,
		_______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , KC_PSCR , KC_SLCK , KC_PAUS ,           _______ , KC_LANG1,
