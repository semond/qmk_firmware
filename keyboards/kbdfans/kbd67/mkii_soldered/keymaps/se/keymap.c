...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
	...
	[_S1] = LAYOUT_65_ansi_blocker( /* Qwerty */
		...
		KC_LCTL , _______ , _______ ,                           _______,                                    _______ , TT(_AR) , _______ , _______ , _______
	),
	...
	[_FN] = LAYOUT_65_ansi_blocker( /* Qwerty */
		KC_GRV  , DF(_QW) , DF(_CM) , TG(_AT) , TG(_S1) , TG(_S2) , _______ , _______ , _______ , _______ , _______ , KC_LANG4, KC_LANG3, KC_INT4 , _______ ,
