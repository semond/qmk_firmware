...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_AR] = LAYOUT_60_ansi(
		...
		MO(_F2),          KC_MUTE, _______, _______, _______, _______, _______, KC_PGUP, KC_UP  , _______, _______, _______, _______, _______,
		...
		TG(_AR), _______,          _______,                   _______,                            _______, _______,          G(_AR), MO(_FN)
	),
	[_F2] = LAYOUT_60_ansi(
