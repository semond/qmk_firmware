...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
	...
	[_G1] = LAYOUT_65_ansi_blocker( /* Gaming 1 */
		_______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,
		_______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,
		KC_LCTL , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,         _______   , _______ ,
		_______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,        _______ ,    _______ , _______ ,
		KC_LALT , KC_CAPS , KC_RCTL ,                           _______,                                    _______ , TT(_S2) , _______ , _______ , _______
	),
	...
	[_S2] = LAYOUT_65_ansi_blocker( /* Qwerty */
		_______ , KC_PSCR , KC_SLCK , KC_PAUS , _______ , _______ , KC_NLCK , KC_KP_7 , KC_KP_8 , KC_KP_9 , KC_PSLS , KC_PAST , KC_PMNS , _______ , _______ ,
		_______ , KC_INS  , KC_HOME , KC_PGUP , _______ , _______ , _______ , KC_KP_4 , KC_KP_5 , KC_KP_6 , KC_PPLS , KC_PPLS , _______ , _______ , _______ ,
		_______ , KC_DEL  , KC_END  , KC_PGDN , _______ , _______ , _______ , KC_KP_1 , KC_KP_2 , KC_KP_3 , KC_PPLS , KC_PENT ,         KC_PENT   , _______ ,
		_______ , _______ , _______ , _______ , _______ , KC_SPC  , KC_KP_0 , KC_KP_0 , KC_PDOT , KC_PDOT , KC_PENT ,        _______ ,    _______ , _______ ,
		_______ , _______ , KC_LGUI ,                           KC_KP_0,                                    _______ , _______ , TT(_AR) , _______ , _______
	),
