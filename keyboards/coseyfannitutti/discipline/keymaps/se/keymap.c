...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * `-------------------------------------------------------------------------┘   └-------------+------´
   */
	[_CM] = LAYOUT_65_ansi_blocker( /* Colemak */
		...
		TT(_AR) ,      KC_LALT ,      KC_LGUI,                            KC_SPC,                                     KC_RALT , MO(_FN) ,           KC_LEFT , KC_DOWN , KC_RGHT
	),
	[_QW] = LAYOUT_65_ansi_blocker( /* Qwerty */
		KC_ESC  ,           KC_1    , KC_2    , KC_3    , KC_4    , KC_5    , KC_6    , KC_7    , KC_8    , KC_9    , KC_0    , KC_MINS , KC_EQL  , KC_BSPC ,           KC_DEL  ,
	...
	[_S1] = LAYOUT_65_ansi_blocker( /* Qwerty */
		_______ ,           _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,           TT(_AR) ,
		...
		KC_LCTL ,      _______ ,      SE_MEH  ,                           _______,                                    _______ , _______ ,           _______ , _______ , _______
	),
	[_S2] = LAYOUT_65_ansi_blocker( /* Qwerty */
	...
	[_AT] = LAYOUT_65_ansi_blocker( /* Qwerty */
		_______ ,           _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,           _______ ,
		_______ ,           _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,           _______ , _______ ,
		_______ ,           _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,         _______   ,           _______ ,
		_______ ,           _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,        _______ ,              _______ , _______ ,
	...
	[_AR] = LAYOUT_65_ansi_blocker( /* Qwerty */
		...
		TT(_AR) ,      _______ ,      _______ ,                           _______,                                    MO(_F2) , MO(_FN) ,           _______ , _______ , _______
	),
	[_F2] = LAYOUT_65_ansi_blocker( /* Qwerty */
	...
	[_MO] = LAYOUT_65_ansi_blocker( /* Qwerty */
		...
		_______ ,      KC_KP_0 ,      KC_PDOT ,                           KC_ACL1,                                    _______ , MO(_FN) ,           _______ , _______ , _______
	),
	[_FN] = LAYOUT_65_ansi_blocker( /* Qwerty */
		KC_GRV  ,           DF(_QW) , DF(_CM) , TG(_AT) , TG(_S1) , TG(_S2) , _______ , _______ , _______ , _______ , _______ , KC_LANG4, KC_LANG3, KC_INT4 ,           KC_LANG2,
		...
		_______ ,           _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,        _______ ,              KC_APP  , KC_END  ,
		_______ ,      _______ ,      _______ ,                           _______,                                    _______ , _______ ,           _______ , _______ , KC_NUBS
	),
	// [___] = LAYOUT_65_ansi_blocker( /* Qwerty */
	// 	_______ ,           _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,           _______ ,
	// 	_______ ,           _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,           _______ , _______ ,
	// 	_______ ,           _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,         _______   ,           _______ ,
	// 	_______ ,           _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,        _______ ,              _______ , _______ ,
